...
import org.myse.crawler.CrawlerConfig;
import org.myse.parser.HtmlParserTool;
import org.myse.search.Crawler;
import org.myse.search.Indexer;
import org.myse.search.LinkFilter;
import org.myse.search.SearchFactory;
import org.myse.search.impl.AttachmentPage;
import org.myse.util.AttachmentUtil;
...
public class CrawlerImpl implements Crawler {
    ...
    public void retrievePage(String url) throws IOException {
        try {
            ...
            } else if (statusLine.getStatusCode() == HttpStatus.SC_OK) { // 成功访问
                if (entity == null) {
